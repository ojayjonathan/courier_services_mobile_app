...
Future<void> main() async {
  ...
  runApp(CourierClient());
}

class CourierClient extends StatefulWidget {
  @override
  _CourierClientState createState() => _CourierClientState();
}

class _CourierClientState extends State<CourierClient> {
  @override
  void initState() {
    super.initState();
